  ...
  if (arr.length > 0) {
    ...
    arr.forEach((country) => {
      ...
      cardContentMain.className =
        "p-3 group-hover:absolute group-hover:top-0 transition-all ease-in duration-300 flex flex-col items-start justify-end group-hover:text-white group-hover:bg-[#00000080] group-hover:w-full group-hover:h-full card__content";
      cardContentBody.className = "hidden group-hover:flex flex-col";
      card.className = "shadow-lg rounded-lg overflow-hidden relative group";
