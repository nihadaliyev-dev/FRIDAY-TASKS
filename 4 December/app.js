...
const findFailedStudents = (students) => {
  let failedStudents = [];

  for (let i = 0; i < students.length; i++) {
    if (students[i].fail) {
      let failedStudentName = students[i].name;
      let failedStudentSurname = students[i].surname;
      let failedStudentAverage = students[i].avgPoint;

      failedStudents.push({
        failed: true,
        name: failedStudentName,
        surname: failedStudentSurname,
        avgPoint: failedStudentAverage,
      });
    }
  }
...
console.log(findFailedStudents(students));
